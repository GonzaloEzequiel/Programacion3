...
require_once(__DIR__."/../Ejercicio17/testAuto.php");
require_once(__DIR__."/Clases/Garage.php");

echo "\n\n---------- EJERCICIO 18 | GARAGE ----------\n\n";

$miGarage = new Garage("Gonzalo S.R.L", 2000.50);
...
echo "\nEntra el Fiat Rojo (auto2) ???\n";
$miGarage->Add($auto2);

echo "\nSale el Peugeot Gris (auto5) ???\n";
$miGarage->Remove($auto5);

echo "\nSale el Fiat Negro (auto1)\n";
